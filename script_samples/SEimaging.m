...
expanNum = [5,2]; % expand the unit cell by Expan_Nx = 3 and Expan_Ny = 2, adaptive
...
[stemImg,SEimage] = STEM_X_SE(Lx, Ly, params, transFuncs,SEobfun,MFP, sliceDist, stackNum,[1,5,10,20,40], 'reduced',...
    cbedOption);
toc;
...
figure
gray=mat2gray(SEimage(:,:,1));
imshow(gray)
figure
gray=mat2gray(SEimage(:,:,2));
imshow(gray)
